...
export function CertificationPreview() {
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-orange-100 rounded-full opacity-20 -translate-y-48 translate-x-48"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-orange-200 rounded-full opacity-10 translate-y-32 -translate-x-32"></div>

      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16">
            <Badge className="mb-6 bg-orange-100 text-orange-800 hover:bg-orange-200 transition-colors duration-300">
              Blockchain Certification
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight">
              Professional & Academic Diplomas in
              <span className="text-orange-600 block md:inline"> Blockchain Technology</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <Card className="p-8 border-2 hover:border-orange-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
            ...
            <Card className="p-8 border-2 hover:border-orange-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group md:col-span-2 lg:col-span-1">
              <CardContent className="pt-6">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-orange-200 transition-colors duration-300">
                  <svg className="w-8 h-8 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
          ...
          <div className="text-center space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-orange-600 text-orange-600 hover:bg-orange-50 px-8 py-3 bg-transparent transition-all duration-300 hover:shadow-lg hover:scale-105"
            >
